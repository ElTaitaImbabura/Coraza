  ...
  return (
    <div className="w-full">
        ...
        {showLineup && (
          <div className="absolute inset-0 flex items-center justify-center z-20">
            <div className="max-w-xl p-8 text-center text-red-200 bg-black/70 rounded-xl backdrop-blur-md">
              <h2 className="mb-4 text-4xl font-bold">IMBABURA PEACE FESTIVAL</h2>
              <h2 className="mb-2 text-2xl">Date: 26.02.2026</h2>
              <h2 className="mb-6 text-2xl">Time: 22:00</h2>
      ...
      <div className="bg-black text-[#B8A03A]">
        ...
        <div className="text-center py-4 font-extrabold text-lg">
          Contact us via email
        </div>

        <div className="text-center pb-6 text-orange-100 text-lg">
